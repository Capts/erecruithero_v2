...
@section('title', 'Welcome to employers panel')
			...
			<div class="col-md-12">
			  <div class="nav-tabs-custom">
			    <ul class="nav nav-tabs">
			      ...
			      <li><a href="#jobpostings" data-toggle="tab">Job postings</a></li>
			    ...
			    <div class="tab-content">
					...
					<div class="tab-pane" id="jobpostings">
					  			...
					  			<div class="col-md-12">
					  				<div class="box box-primary">
					  					<div class="box-header">
					  						<h3 class="box-title">List of all job postings</h3>
					  					</div>
					  					<!-- /.box-header -->
					  					<div class="box-body no-padding">
					  						<table class="table">
					  							...
					  							@foreach ($alljobs as $aj)
						  							<tr>
						  								<td>{{ $aj->id }}</td>
						  								<td><a href="{{ route('job.show', $aj->id) }}">{{ $aj->job_title }}</a></td>
						  								<td>
						  									<span class="badge badge-warning">{{ $aj->applicant_needed }}</span>
						  								</td>
						  							</tr>
												@endforeach
					  						</table>
