    ...
    <div class="register-box" style=" margin-top: 35px;">
        ...
        <div class="register-box-body" >
            ...
            <form class="form-horizontal" method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group has-feedback<?php echo e($errors->has('lastname') ? ' has-error' : ''); ?>">
                                <span class="fa fa-user-o form-control-feedback"></span>
                        ...
                        <div class="form-group has-feedback<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                                ...
                                <input id="email" type="email" class="form-control" name="email" value="<?php echo e(old('email')); ?>" required placeholder="Email">
