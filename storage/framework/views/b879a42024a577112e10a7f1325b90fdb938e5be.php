							...
							<div class="row">
				                			...
				                			<legend><h5 style="margin-left: 10px;color:#40a04d;"><b>Basic information</b></h5></legend>
		                							...
		                							<div class="col-xs-4">
		                								...
		                								<div class="form-group<?php echo e($errors->has('bday') ? ' has-error' : ''); ?>">
		                								  ...
		                								  <div class="input-group date">
		                								    ...
		                								    <?php echo Form::text('bday', ( isset($users->profile->bday) ? $users->profile->bday : null ), ['class' => 'form-control pull-right', 'id' => 'datepicker']); ?>
		                							...
		                							<div class="col-xs-4">
		                								<div class="form-group<?php echo e($errors->has('age') ? ' has-error' : ''); ?>">
		                								    ...
		                								    <?php echo Form::text('age', ( isset($users->profile->age) ? $users->profile->age : null ), ['class' => 'form-control', 'required' => 'required']); ?>
												...
												<legend><h5 style="margin-left: 10px;color:#40a04d;"><b>Contact Details</b></h5></legend>
		                							...
		                							<div class="col-xs-6">
		                								<div class="form-group<?php echo e($errors->has('telephone') ? ' has-error' : ''); ?>">
		                								    ...
		                								    <?php echo Form::text('telephone', ( isset($users->profile->telephone) ? $users->profile->telephone : null ), ['class' => 'form-control']); ?>
								...
								<div class="col-md-6">
									...
									<div class="col-md-12">
										...
										<?php echo Form::submit('save profile', ['class' => 'btn-block btn btn-success btn-flat btx-sm pull-right', 'style' => 'margin-top:290px']); ?>
