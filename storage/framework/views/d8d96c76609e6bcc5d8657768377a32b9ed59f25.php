			                				...
			                				<div class="col-md-12">
												...
												<div class="col-xs-4">
													...
													<div class="form-group<?php echo e($errors->has('bday') ? ' has-error' : ''); ?>">
													  ...
													  <div class="input-group date">
													    ...
													    <?php echo Form::text('bday', null, ['class' => 'form-control pull-right', 'id' => 'datepicker']); ?>
												...
												<div class="col-xs-4">
													<div class="form-group<?php echo e($errors->has('age') ? ' has-error' : ''); ?>">
													    ...
													    <?php echo Form::number('age', null, ['class' => 'form-control', 'required' => 'required']); ?>
			                				...
			                				<div class="col-md-12">
			                					...
			                					<div class="col-xs-6">
			                						...
			                						<div class="form-group<?php echo e($errors->has('telephone') ? ' has-error' : ''); ?>">
			                						    ...
			                						    <?php echo Form::number('telephone', null, ['class' => 'form-control']); ?>
