    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <a href="#"><i class="fa fa-envelope"></i><?php echo e(Auth::user()->email); ?></a>
        </div>
      </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu" style="padding-left:25px;">
            <li><a href="<?php echo e(route('profile.index', [Auth::user()->id, Auth::user()->slug] )); ?>"><i class="fa fa-odnoklassniki"></i> view profile</a></li>
            <li><a href="<?php echo e(route('profile.edit', Auth::user()->id)); ?>"><i class="fa fa-pencil"></i> edit profile</a></li>
          </ul>
        </li>
