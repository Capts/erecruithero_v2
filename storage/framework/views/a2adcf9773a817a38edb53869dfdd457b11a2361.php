<!-- Modal for tertiary-->
	...
	<!-- Modal -->
	<div class="modal fade" id="edit_job_modal" tabindex="1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-gavel fa-2x">&nbsp;</i>Edit this job</h4>
	      </div>
	      		...
	      		<div class="col-md-12">
	      			...
	      			<?php echo Form::model($job, ['route' => ['job.update', $job->id], 'method' => 'PUT']); ?>
	      			    ...
	      			    <div class="row">
	      			    	...
	      			    	<div class="col-xs-6">
	      			    		<div class="form-group<?php echo e($errors->has('salary') ? ' has-error' : ''); ?>">
	      			    		    ...
	      			    		    <?php echo Form::text('salary', null, ['class' => 'form-control', 'placeholder' => 'Leave blank if salary is to be discuss.']); ?>
	      			    ...
	      			    <div class="btn-group pull-right">
	      			        <?php echo Form::submit("update now", ['class' => 'btn btn-flat bg-olive', 'name' => 'btnUpdate', 'value' => 'update']); ?>
